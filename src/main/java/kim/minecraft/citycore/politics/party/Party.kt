...
@Serializable
data class Party(var name: String, var ideology: String, @Serializable(with = UUIDAsStringSerializer::class) var belongingsCountry: UUID?, @Serializable(with = UUIDAsStringSerializer::class) var ownerHumanRace: UUID, val operatorHumanRaces: MutableList<@Serializable(with = UUIDAsStringSerializer::class) UUID>, override val members: MutableList<@Serializable(with = UUIDAsStringSerializer::class) UUID>, override val wallet: Wallet) : MemberHolder, WalletHolder, CountryOwner, CompanyOwner {
